...
bot.on(`ready` , () => {
    ...
    bot.user.setActivity("Release | Alpmon")
});
...
bot.on(`message`, msg => {
    ...
    bot.login("FAZVZXVfsdsfQQAjIwNDE0NzA2OTAwOQ.GQz0sz.P4YytJvQV-AdBc3VyD-J2TQXLMS_eCRGFyNVXI")